...
func minmaxints(){
    ...
    print("The minimum integer (64 bit) value is \(minint)") 
    print("The maximum integer(8 bit) value is \(maxint)")
    print("Both of these things added up are \(wtf) - it's also 64 bit value btw") // printing the results
